...
file_path = 'https://raw.githubusercontent.com/lwyay/Dashboard2/main/Daily%20Ridership%20-%20Data%20View%20(1).csv'
...
def update_table(selected_year, selected_month):
    ...
    if selected_year and selected_month:
        month_data = data[(data['Year'] == int(selected_year)) & (data['Month'] == selected_month)]
        if month_data.empty:
            return [], default_columns
